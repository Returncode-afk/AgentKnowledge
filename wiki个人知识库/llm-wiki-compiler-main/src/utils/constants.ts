...
/** LLM Model configuration - supports Doubao, Claude, GPT, etc. */
export const MODEL = process.env.MODEL || "doubao-seed-1-6-251015";

/** OpenAI-compatible API configuration */
export const OPENAI_API_KEY = process.env.OPENAI_API_KEY || process.env.HICLAW_LLM_API_KEY;
export const OPENAI_BASE_URL = process.env.OPENAI_BASE_URL || process.env.HICLAW_OPENAI_BASE_URL || "https://ark.cn-beijing.volces.com/api/v3";
